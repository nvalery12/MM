...
public class VProductos extends javax.swing.JFrame {
    ...
    public VProductos(String agencia, int tipo) {
        Type = tipo;
        agency = agencia;
        initComponents();
        db.obtenerLinea(LineaSumi);
    }
    ...
    private void initComponents() {
        ...
        LineaSumi = new javax.swing.JComboBox<>();
        ...
        codLSButton.setFont(new java.awt.Font("Helvetica", 1, 14)); // NOI18N
        ...
        getContentPane().add(codLSButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(885, 135, 140, 40));
        ...
        LineaSumi.setBackground(new java.awt.Color(240, 240, 240));
        LineaSumi.setFont(new java.awt.Font("Helvetica", 1, 14)); // NOI18N
        LineaSumi.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(36, 204, 167), 3));
        getContentPane().add(LineaSumi, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 140, 260, 35));
    ...
    private void Btn_ActuaizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_ActuaizarActionPerformed
        if (!(this.CodPrText.getText().equals("")) && !(this.MinPrText.getText().equals("")) && !(this.PrecioPrText.getText().equals("")) && !(this.EcoPrText.getText().equals(""))
                && !(this.NombPrText.getText().equals("")) && !(this.MaxPrText.getText().equals("")) && !(this.LineaSumi.getSelectedItem().toString().equals(""))
            ...
            try {
                ...
                db.updateProducto(this.CodPrText.getText(), this.NombPrText.getText(), itemls, max, min, monto, 
    ...
    private void Btn_BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_BuscarActionPerformed
        if (!(this.CodPrText.getText().equals(""))) {
            ...
            this.LineaSumi.setSelectedItem(datoAr[1]);
        ...
        if (!(this.CodPrText.getText().equals("")) && !(this.MinPrText.getText().equals("")) && !(this.PrecioPrText.getText().equals("")) && !(this.EcoPrText.getText().equals(""))
            ...
            try {
                ...
                if ((this.EcoPrText.getText().equals("S"))||(this.EcoPrText.getText().equals("N"))) {
                    db.agregarProductor(this.CodPrText.getText(), this.NombPrText.getText(), itemls, max, min, monto, 
                        this.EcoPrText.getText(), this.DescPrText.getText(), this.FabriPrText.getText(), cant);
                }else{
