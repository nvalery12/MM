...
public class VLineaS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setFont(new java.awt.Font("Helvetica", 1, 17)); // NOI18N
        ...
        jLabel3.setFont(new java.awt.Font("Helvetica", 1, 17)); // NOI18N
        ...
        getContentPane().add(codText, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 190, 370, 30));
        ...
        getContentPane().add(desText, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 290, 430, 30));
        ...
        searchBotton.setContentAreaFilled(false);
        searchBotton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                searchBottonActionPerformed(evt);
            }
        });
        getContentPane().add(searchBotton, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 190, 50, 30));
        ...
        Btn_Habilitar1.setFont(new java.awt.Font("Helvetica", 1, 17)); // NOI18N
        ...
        Btn_Nuevo1.setFont(new java.awt.Font("Helvetica", 1, 17)); // NOI18N
        ...
        Btn_Actuaizar1.setFont(new java.awt.Font("Helvetica", 1, 17)); // NOI18N
        ...
        Btn_Eliminar1.setFont(new java.awt.Font("Helvetica", 1, 17)); // NOI18N
        ...
        Btn_Limpiar1.setFont(new java.awt.Font("Helvetica", 1, 17)); // NOI18N
        ...
        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 420, 750, 130));
        ...
        getContentPane().add(Btn_Aceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 570, 140, 40));

        jLabel5.setBackground(new java.awt.Color(255, 255, 255));
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/Sin título-2.png"))); // NOI18N
        jLabel5.setOpaque(true);
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 180, 100));

        jLabel6.setBackground(new java.awt.Color(36, 204, 167));
        jLabel6.setFont(new java.awt.Font("Helvetica", 1, 48)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("Encargado");
        jLabel6.setOpaque(true);
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 0, 670, 100));
