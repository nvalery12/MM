...
public class VClientes extends javax.swing.JFrame {
    ...
    CRUDClientes ct = new CRUDClientes(conexion.conectar());
    ...
    private void initComponents() {
        ...
        getContentPane().add(TF_Nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 220, 360, 35));
        ...
        getContentPane().add(TF_CiCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 170, 360, 35));

        TF_Email.setFont(new java.awt.Font("Helvetica", 1, 14)); // NOI18N
        TF_Email.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(36, 204, 167), 3));
        TF_Email.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TF_EmailActionPerformed(evt);
            }
        });
        getContentPane().add(TF_Email, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 270, 360, 35));

        TF_Telefono1.setFont(new java.awt.Font("Helvetica", 1, 14)); // NOI18N
        TF_Telefono1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(36, 204, 167), 3));
        TF_Telefono1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TF_Telefono1ActionPerformed(evt);
            }
        });
        getContentPane().add(TF_Telefono1, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 320, 360, 35));

        TF_Telefono2.setFont(new java.awt.Font("Helvetica", 1, 14)); // NOI18N
        TF_Telefono2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(36, 204, 167), 3));
        TF_Telefono2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TF_Telefono2ActionPerformed(evt);
            }
        });
        getContentPane().add(TF_Telefono2, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 370, 360, 35));
        ...
        getContentPane().add(Btn_Buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 170, 30, 30));
    ...
    private void TF_Telefono2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TF_Telefono2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TF_Telefono2ActionPerformed
    ...
    private void Btn_NuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_NuevoActionPerformed
        if (!(this.TF_CiCliente.getText().equals("")) && !(this.TF_Nombre.getText().equals("")) && !(this.TF_Email.getText().equals("")) && !(this.TF_Telefono1.getText().equals("")) && !(this.TF_Telefono2.getText().equals("") && !(this.TF_RifAg.getText().equals("")))) {

            String CedulaCt = this.TF_CiCliente.getText();
            String RifAg = this.TF_RifAg.getText();
            String NombreCt = this.TF_Nombre.getText();
            String EmailCt = this.TF_Email.getText();
            String Telef1 = this.TF_Telefono1.getText(); 
            String Telef2 = this.TF_Telefono2.getText();
            

            ct.nuevoClientes(CedulaCt,RifAg,NombreCt, EmailCt,Telef1,Telef2);
    ...
    private void Btn_ActuaizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_ActuaizarActionPerformed
        if (!(this.TF_CiCliente.getText().equals("")) && !(this.TF_Nombre.getText().equals("")) && !(this.TF_Email.getText().equals("")) && !(this.TF_Telefono1.getText().equals("")) && !(this.TF_Telefono2.getText().equals("") && !(this.TF_RifAg.getText().equals(""))) ) {
            ...
            ct.actualizarClientes(CedulaCt,RifAg,NombreCt, EmailCt,Telef1,Telef2);
    ...
    private void Btn_EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_EliminarActionPerformed
        if (!(this.TF_CiCliente.getText().equals(""))) {
            String CtCliente = this.TF_CiCliente.getText();

            ct.eliminarCliente(CtCliente);
        }
    ...
    private void Btn_LimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_LimpiarActionPerformed
        ...
        this.TF_Telefono1.setText("");
        this.TF_Email.setText("");
        this.TF_Telefono2.setText("");
        this.TF_RifAg.setText("");
        this.TF_CiCliente.setEnabled(false);
        this.TF_Nombre.setEnabled(false);
        this.TF_Telefono1.setEnabled(false);
        this.TF_Email.setEnabled(false);
        this.TF_Telefono2.setEnabled(false);
    ...
    private void Btn_BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_BuscarActionPerformed
        if (!(this.TF_CiCliente.getText().equals(""))) {
            ...
            String[] datosAr = ct.buscarClientes(TF_CiCliente.getText());

            this.TF_Nombre.setText(datosAr[0]);
            this.TF_Email.setText(datosAr[1]);
            this.TF_Telefono1.setText(datosAr[2]); 
            this.TF_Telefono2.setText(datosAr[3]);
    ...
    private void Btn_Buscar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_Buscar1ActionPerformed
       if (!(this.TF_RifAg.getText().equals(""))) {
            String nombencargado = this.ct.buscarAgencia(Integer.parseInt(this.TF_RifAg.getText()));
            if ((nombencargado.equals(""))) {
                JOptionPane.showMessageDialog(null, "Agencia no encontrada. Por favor, ingrese un RIF registrado o registre un nuevo cliente", "Advertencia", JOptionPane.WARNING_MESSAGE);
                this.TF_RifAg.setText("");
            } else {
